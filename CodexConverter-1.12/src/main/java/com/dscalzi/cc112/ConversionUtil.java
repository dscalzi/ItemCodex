...
public class ConversionUtil {
	...
	public static boolean isPotionable(ItemStack i) {
		return ConversionUtil.isPotionable(i.getType());
	}
	...
	public static void convert() throws FileNotFoundException, IOException {
		File file = new File("plugins/CodexConverter112/items.csv");
		System.out.println(file.getAbsolutePath());
		File target = new File("plugins/CodexConverter112/items.json");
